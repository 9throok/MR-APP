  ...
  return (
    <div className="followup-tasks-page">
      ...
      <main className="followup-tasks-content">
        <div className="followup-tasks-header">
          <button className="back-button" onClick={onBack} aria-label="Go back">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M19 12H5M5 12L12 19M5 12L12 5" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </button>
          <div className="followup-header-content">
            <h1 className="followup-tasks-title">Follow-up Tasks</h1>
            <p className="followup-tasks-subtitle">Track and manage your doctor follow-up actions</p>
          </div>
        </div>
